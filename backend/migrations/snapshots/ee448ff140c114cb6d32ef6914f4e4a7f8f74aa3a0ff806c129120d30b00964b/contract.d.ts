...
export type StorageHash =
  StorageHashBase<'ee448ff140c114cb6d32ef6914f4e4a7f8f74aa3a0ff806c129120d30b00964b'>;
...
export namespace Models {
  ...
  export type public_ProfilesSkills = {
...
export declare const models: {
  public: {
    ...
    ProfilesSkills: Models.public_ProfilesSkills;
  };
};
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly profilesSkills: {
              ...
              primaryKey: { readonly columns: readonly ['profileId', 'skillId'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'profilesSkills_profileId_idx_d9cdfcaf';
                  readonly prefix: 'profilesSkills_profileId_idx';
                  readonly columns: readonly ['profileId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'profilesSkills_skillId_idx_6e19993d';
                  readonly prefix: 'profilesSkills_skillId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'profilesSkills';
                    readonly columns: readonly ['profileId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
